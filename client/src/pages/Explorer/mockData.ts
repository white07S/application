...
export const mockRiskTaxonomies: RiskTaxonomy[] = [
    {
        ...
        themes: [
            { id: 'rt-1-1', name: 'Process Execution' },
            { id: 'rt-1-2', name: 'Technology Failure' },
            { id: 'rt-1-3', name: 'Third-Party Risk' },
            { id: 'rt-1-4', name: 'Data Management' },
        ],
    },
    {
        id: 'tax-2',
        ...
        themes: [
            { id: 'rt-2-1', name: 'Regulatory Change' },
            { id: 'rt-2-2', name: 'Financial Crime' },
            { id: 'rt-2-3', name: 'Conduct Risk' },
        ],
    },
    {
        id: 'tax-3',
        name: 'Financial Risk',
        themes: [
            { id: 'rt-3-1', name: 'Credit Risk' },
            { id: 'rt-3-2', name: 'Market Risk' },
            { id: 'rt-3-3', name: 'Liquidity Risk' },
        ],
    },
];
