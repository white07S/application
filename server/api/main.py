...
from server.pipelines.controls.api.config import router as config_router
from server.pipelines.controls.api.processing import router as processing_router
from . import docs
from . import health
